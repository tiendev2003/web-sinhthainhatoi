...
import TableManagement from "../pages/AdminPage/TableManagement/TableManagement";
...
import MyTableBookingsPage from "../pages/MyTableBookingsPage/MyTableBookingsPage";
...
export const routes = [
  ...
  {
    path: "/my-table-bookings",
    page: MyTableBookingsPage,
    isShowHeader: true,
  },
  {
