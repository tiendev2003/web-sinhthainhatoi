                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item lg={6}>
                      <CircularProgressbar
                        value={
                          dashboard &&
                          (dashboard.orderRevenue / dashboard.totalRevenue) *
                            100
                        }
                        text={`${(dashboard
                          ? (dashboard.orderRevenue / dashboard.totalRevenue) *
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item lg={6}>
                      <CircularProgressbar
                        value={
                          dashboard &&
                          (dashboard.bookingRevenue / dashboard.totalRevenue) *
                            100
                        }
                        text={`${(dashboard
              ...
              <Grid container spacing={2}>
                ...
                <Grid item lg={12}>
                  ...
                  >
                    <CountUp
                      start={0}
                      end={dashboard && dashboard.todayRevenue}
                      duration={3}
                    />
                  </Typography>
                </Grid>
                <Grid sx={{ margin: "20px" }} item lg={12}>
                  ...
                  <Box>
                    ...
                    >
                      <CountUp
                        start={0}
                        end={dashboard && dashboard.totalRevenue}
                        duration={3}
                      />
                    </Typography>
                  </Box>
